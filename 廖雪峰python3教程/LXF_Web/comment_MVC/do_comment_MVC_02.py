...
# 需求参考：https://www.cnblogs.com/wanghao1521/p/6581597.html
# 为了能给别的同学参考，我把所有东西都写在一个Py文件里了
...
def executeSql(sql, params=None, isQuery=False):
    ...
    results = []
    # 打开一个数据库连接
    db_conn = pymysql.connect(host="127.0.0.1", user="root", password="admin", db="exercise_st")
